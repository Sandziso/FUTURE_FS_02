...
// --- Staff-specific: pending tasks assigned to current user ---
$pendingTasks = 0;
...
<!-- Staff‑specific Pending Tasks Card -->
    ...
    <div class="col-12 mb-4">
        <div class="card border-left-secondary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">My Pending Tasks</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $pendingTasks; ?></div>
                    </div>
                    <div class="col-auto">
...
<!-- Optional: Lead Source Performance (simplified) -->
<div class="row">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <table class="table table-sm">
                    <thead><tr><th>Source</th><th>Total Leads</th></tr></thead>
                    <tbody>
    ...
    <div class="col-xl-6 mb-4">
        <div class="card shadow">
            ...
            <div class="card-body">
                <p>Total Clients: <strong><?php echo $pdo->query("SELECT COUNT(*) FROM clients")->fetchColumn(); ?></strong></p>
                <p>Outstanding Revenue: <strong><?php echo formatCurrency($outstandingRevenue); ?></strong></p>
...
<script>
    ...
    <?php else: ?>
    document.getElementById('sourceChart').parentNode.innerHTML = '<p class="text-muted text-center my-3">No source data available.</p>';
    <?php endif; ?>
